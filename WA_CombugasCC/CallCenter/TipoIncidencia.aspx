<%@ Page Title="" Language="C#" MasterPageFile="~/CallCenter/CallCenter.Master" AutoEventWireup="true" CodeBehind="TipoIncidencia.aspx.cs" Inherits="WA_CombugasCC.CallCenter.TipoIncidencia" %>
    ...
    <div class="page-content-wrapper">
                            ...
                            <div class="portlet light ">  
                                <div class="portlet-title">
                                    <div class="caption caption-md col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                         ...
                                         <center><h4 style="margin-top: 5px;">Agregar un tipo de incidencia</h4></center>
                                    </div>
                                </div>     
                                <div class="portlet-body">
                                    <div class="row">         
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <center><label style="margin-top: 5px;">Descripción</label></center>
     ...
     <script type="text/javascript">
        ...
        function actualizaTabla() {
            ...
            $.ajax({
                type: "POST",
                url: "TipoIncidencia.aspx/CargarDatos",
                data: "{}",
        ...
        function Guardar() {
           //NOMBRE
            ...
            if (Nombre == "") {
                toastr.error("La descripción es requerida.", "Advertencia");   
            } else {
                $.ajax({
                    type: "POST",
                    url: "TipoIncidencia.aspx/Guardar",
                    ...
                    success: function (response) {
                        if (response.d.Result) {
                            Limpiar();
                            toastr.success("El tipo de incidencia ha sido agregado correctamente", "Éxito");
                        } else {
        ...
        $("#btnEditar").click(function () {
            if (GBLIDOPERA == -1) {
                ...
                if (Nombre == "" ) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "TipoIncidencia.aspx/Actualizar",
                        ...
                        success: function (response) {
                            ...
                            $("#btnEditar").hide("fast");
                            Limpiar();
                            toastr.success("El tipo de incidencia ha sido actualizado correctamente", "Éxito");
                        },
                        error: function (error) {
                            console.log("ERROR: " + error);
                        }
