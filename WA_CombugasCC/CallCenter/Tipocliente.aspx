<%@ Page Title="" Language="C#" MasterPageFile="~/CallCenter/CallCenter.Master" AutoEventWireup="true" CodeBehind="Tipocliente.aspx.cs" Inherits="WA_CombugasCC.CallCenter.Tipocliente" %>
                            ...
                            <div class="portlet light ">  
                                <div class="portlet-title">
                                    <div class="caption caption-md col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                         ...
                                         <center><h4 style="margin-top: 5px;">Agregar un tipo de cliente</h4></center>
                                    </div>
                                </div>     
                                <div class="portlet-body">
                                    <div class="row">         
        ...
        $("#btnEditar").click(function () {
            if (GBLIDOPERA == -1) {
                ...
                if (Nombre == "" ) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "Tipocliente.aspx/Actualizar",
