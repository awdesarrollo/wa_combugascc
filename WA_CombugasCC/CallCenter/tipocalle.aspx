<%@ Page Title="" Language="C#" MasterPageFile="~/CallCenter/CallCenter.Master" AutoEventWireup="true" CodeBehind="tipocalle.aspx.cs" Inherits="WA_CombugasCC.CallCenter.tipocalle" %>
...
<div class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" id="mdAgrega">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" >Modificar tipo de calle</h4>
      </div>
 ...
 <script type="text/javascript">
        ...
        function actualizaTabla() {
            ...
            $.ajax({
                type: "POST",
                url: "tipocalle.aspx/CargarDatos",
                data: "{}",
        ...
        function Guardar() {
            ...
            if (Nombre == "") {
                toastr.error("Ingrese un nombre del tipo de calle.", "Advertencia");
               
            } else {
                
                $.ajax({
                    type: "POST",
                    url: "tipocalle.aspx/Guarda",
                    data: '{ Nombre:"' + Nombre + '" }',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (response) {
                        if (response.d.Result) {
                            $("#nombrezona").val('');
                            actualizaTabla();
                            toastr.success("El tipo de calle ha sido agregado correctamente", "Éxito");
                        } else {
                ...
                if (Nombre == "") {
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            actualizaTabla();
                            $('#mdAgrega').modal('hide');
                            toastr.success("El tipo de calle ha sido actualizado correctamente", "Éxito");
                        },
                        error: function (error) {
                            console.log("ERROR: " + error);
                        }
