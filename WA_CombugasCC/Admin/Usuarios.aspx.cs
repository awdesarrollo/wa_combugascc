...
namespace WA_CombugasCC.Admin
{
    public partial class Usuarios : System.Web.UI.Page
    {
        ...
        public static ajaxResponse CargaUsuarios()
        {
            ...
            try
            {
                ...
                foreach (var user in objUsuarios)
                {
                    ...
                    users.Add(new usuariosClass(user.id_usuario, user.username, user.passwords, user.nombre, user.roles.descripcion, (bool)user.isactive, (int)user.id_rol, fechaultimo));
                }
        ...
        public static ajaxResponse ObtieneUsuarioId(int idusuario)
        {
            ...
            {
                ContextCombugasDataContext context = new ContextCombugasDataContext();
                usuarios objUsuario = (from usuario in context.usuarios
                                     where usuario.id_usuario == idusuario
                                     select usuario).SingleOrDefault();

                usuariosClass user = new usuariosClass(objUsuario.id_usuario, objUsuario.username, objUsuario.passwords, objUsuario.nombre, objUsuario.roles.descripcion, (bool)objUsuario.isactive, (int)objUsuario.id_rol, objUsuario.horaultimoacceso.Value.ToLongDateString());
        ...
        public static ajaxResponse EditaUsuarios(string usuario, string password, string nombre, bool estatus, int idrol, int idusuario)
        {
            ...
            try
            {
                ...
                {
                    usuarios user = context.usuarios.Where(x => x.id_usuario == idusuario).SingleOrDefault();
